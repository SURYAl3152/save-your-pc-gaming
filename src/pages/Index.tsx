    ...
    <div className="min-h-screen p-6 space-y-6">
      ...
      <div className="glass-card card-hover mb-8">
        <div className="flex items-center justify-between">
          <div>
            <span className="text-sm text-neutral">GTA V Cloud Gaming</span>
        ...
        <button className="bg-primary text-white px-6 py-3 rounded-lg font-medium flex items-center hover:bg-opacity-90 transition-all">
          Launch Game
